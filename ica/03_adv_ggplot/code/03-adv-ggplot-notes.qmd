...
> **Response:** NYTimes wants readers to input whatever city they want to and observe average temperatures and total precipitation levels across 2015.
  
  - How did this goal inform what information is displayed in the visualization?
  
> **Response:** This goal informed the visualization's information by highlighting the varying levels of temperatures that were recorded ever, and comparing to the ones recorded from 2015.

**Aesthetic Mapping** 

- What specific variables (from the data codebook) underlie the visualization?

> **Response:** Month, Day, Low/High, NormalLow/NormalHigh, RecordLow/RecordHigh, Precip, RecordPrecip, CulmPrecip
