...
```{r reading}
#| eval: false
data_by_dist <- read_rds("../data/raw/diverse_data_by_dist.rds")
data_by_year <- read_csv("../data/raw/https:mac-stat.github.io:data:diverse_data_by_year.csv")
```
