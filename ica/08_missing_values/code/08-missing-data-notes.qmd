...
ggplot(airquality, aes(x = Month, y = Ozone)) +
    geom_point() +
    geom_smooth() +
    geom_vline(data = airquality |> filter(is.na(Ozone)), mapping = aes(xintercept = Month)) +
    labs(title = "Ozone Missingness: Month")  

ggplot(airquality, aes(x = Wind, y = Ozone)) +
    geom_point() +
    geom_smooth() +
    geom_vline(data = airquality |> filter(is.na(Ozone)), mapping = aes(xintercept = Wind)) +
    labs(title = "Ozone Missingness: Wind")  

ggplot(airquality, aes(x = Temp, y = Ozone)) +
    geom_point() +
    geom_smooth() +
    geom_vline(data = airquality |> filter(is.na(Ozone)), mapping = aes(xintercept = Temp)) +
    labs(title = "Ozone Missingness: Temp") 
```
